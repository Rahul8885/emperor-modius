...
export default class PreloadScene extends Phaser.Scene {
  ...
  preload() {
    ...
    // Enemy Sprites
    loadSprite('ufo_hover', enemiesPath + 'cockroach_flying.png')
    loadSprite('ufo_explosion', enemiesPath + 'cockroach_explosion.png')
    this.load.image('enemy_freedom_of_speech', enemiesPath + 'freedom_of_speech.png')
    this.load.image('enemy_peaceful_protest', enemiesPath + 'peaceful_protest.png')
    this.load.image('enemy_press_meet', enemiesPath + 'press_meet.png')

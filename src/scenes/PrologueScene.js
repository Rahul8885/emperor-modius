...
export default class PrologueScene extends Phaser.Scene {
  ...
  startCrawl() {
    ...
    const crawlLines = [
      ...
      { text: 'A long time ago, in the glorious Kingdom of the Indus...', big: false },
      { text: 'Demonic cockroaches emerged, spreading forbidden words across the realm...', big: false },
      { text: '"Press Meetings." "Freedom of Speech." "Peaceful Protests."', big: false },
      { text: 'Only the great EMPEROR MODIUS possessed the courage and divine laser to purge the kingdom of this infestation.', big: false },
      { text: 'LONG LIVE THE EMPEROR.', big: true }
    ]

//     > A long time ago, in the glorious Kingdom of the Indus...

// Demonic cockroaches emerged, spreading forbidden words across the realm...

// "Press Meetings." "Freedom of Speech." "Peaceful Protests."

// Only the great Emperor Modius possessed the courage and divine laser to purge the kingdom of this infestation.
